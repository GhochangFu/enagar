...
| **Tenant login loops**      | `KEYCLOAK_JWKS_URL=http://127.0.0.1:8080/realms/enagar/protocol/openid-connect/certs` in `infrastructure\.env` (issuer stays HTTPS public URL) |
