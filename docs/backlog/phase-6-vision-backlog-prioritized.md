...
**Baseline shipped:** Master Sprints **6.1–6.11** (Tenant + State portals, catalogue alignment, designer polish, P1 operator polish, P2 reporting/bulk ops/state visibility, P3 governance/transparency, P4 content/reports/branding/bookings).
...
_Last updated: 2026-05-16 (P1 rows closed engineering in Master Sprint 6.8; P2 rows closed engineering in Master Sprint 6.9; P3 rows closed engineering in Master Sprint 6.10; P4 rows closed engineering in Master Sprint 6.11)._
