...
export const globalServices: GlobalServiceSeed[] = [
  ...
  },
  {
    ...
    name: label('Smart Parking', 'স্মার্ট পার্কিং', 'स्मार्ट पार्किंग'),
    description: label(
      'Reserve a parking bay with zone-based hourly pricing.',
      'জোন ভিত্তিক ঘণ্টা প্রতি মূল্যে পার্কিং বে বুক করুন।',
      'क्षेत्र-आधारित प्रति घंटा दर पर पार्किंग बे आरक्षित करें।',
    ),
    workflow_pattern: 'booking',
    default_sla_days: null,
    fee_type: 'computed',
    fee_config: { currency: 'INR' },
    payment_schedule: 'upfront_only',
    fee_lines: {
