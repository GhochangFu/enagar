...
| `GET /api/citizen/dashboard`                                                                              | Sprint 2.2 hub snapshot — per-ULB counts (applications, payments, grievances); optional scope header |
| `POST /api/auth/aadhaar-link`                                                                             | Placeholder; real DigiLocker is blocked                                                              |
| `POST /api/grievances`, `GET /api/grievances`, `GET /api/grievances/:id`                                  | Sprint 4.1 grievances + timeline (PWA Grievances tab + staff; `:id` = UUID or `grievance_no`)        |
