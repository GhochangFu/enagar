    ...
    <main className="flex min-h-screen items-center justify-center bg-canvas px-6 py-16">
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="rounded-3xl border border-warm-border bg-surface p-8 shadow-sm">
          ...
          <h1 className="mt-4 text-2xl font-bold text-ink-primary">You have left Tenant Admin</h1>
          ...
          <div className="mt-6 flex flex-col gap-3">
            <a
              href={hubUrl}
              className="inline-flex w-full items-center justify-center rounded-2xl bg-brand px-5 py-3 text-sm font-semibold text-brand-fg shadow-sm transition hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/30"
            >
              Home — eNagar portal
            </a>
            <Link
