...
| `unified-portal-env-matrix.spec.ts` | Unified Portal Option A — prod env templates + `demo-hosts.json` (Phase 3)                                                                                                             | Portal 3   |
| `unified-portal-cors.spec.ts`       | Unified Portal Option A — API + MinIO CORS templates (Phase 5)                                                                                                                         | Portal 5   |
| `unified-portal-local-dev.spec.ts`  | Unified Portal Option A — local dev hub + start guide (Phase 6)                                                                                                                        | Portal 6   |
| `unified-portal-hub.spec.ts`        | Unified Portal Option A — static hub assets + no auth link (Phase 7)                                                                                                                   | Portal 7   |
| `unified-portal-phase7.spec.ts`     | Unified Portal Option A — VM guide, manual QA, security review package (Phase 7)                                                                                                       | Portal 7   |
| `unified-portal-keycloak.spec.ts`   | Unified Portal Option A — Keycloak realm demo URIs (Phase 4)                                                                                                                           | Portal 4   |
