...
| I⅞++ | Master | **Phase 8 — Bookings, Smart-City & Tenders**                                                  | **In progress** — Jira [**EN-10**](https://ghochangfu.atlassian.net/browse/EN-10) — **Sprint 8.1 closed 2026-06-03** · **Sprint 8.2 closed 2026-06-18** ([`master-sprint-82-exit.md`](docs/runbooks/master-sprint-82-exit.md) · [**EN-23**](https://ghochangfu.atlassian.net/browse/EN-23)) — [§ Phase 8](#phase-8--bookings-smart-city--tender-modules) |
