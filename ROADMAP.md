...
| I¾   | Master | **Sprints 6.14–6.20** — Phase UX cross-portal revamp (Tricolor Calm + tenant themes + mobile) | **Closed** 2026-05-19 — [`phase-ux-revamp-plan.md`](docs/runbooks/phase-ux-revamp-plan.md) · [`master-sprint-620-exit.md`](docs/runbooks/master-sprint-620-exit.md)                                                                                                                                                   |
| I⅞   | Master | **Sprints 6.21–6.24** — Grievance taxonomy (configurable categories + sub-types)              | **Closed engineering 2026-05-20** — [`master-sprint-624-exit.md`](docs/runbooks/master-sprint-624-exit.md) · [`grievance-taxonomy-programme.md`](docs/runbooks/grievance-taxonomy-programme.md)                                                                                                                       |
| I⅞+  | Master | **Phase 7 — Sahayak AI** (RAG + KB + LLM adapter)                                             | **Closed engineering 2026-06-03** — Jira [**EN-14**](https://ghochangfu.atlassian.net/browse/EN-14) · [`phase-7-exit.md`](docs/runbooks/phase-7-exit.md) · Sprints **7.1–7.4** — [§ Phase 7](#phase-7--sahayak-ai-rag--kb-indexing--llm-adapter)                                                                      |
| I⅞++ | Master | **Phase 8 — Bookings, Smart-City & Tenders**                                                  | **In progress** — Jira [**EN-10**](https://ghochangfu.atlassian.net/browse/EN-10) — **Sprint 8.1 closed 2026-06-03** ([`master-sprint-81-exit.md`](docs/runbooks/master-sprint-81-exit.md) · [**EN-15**](https://ghochangfu.atlassian.net/browse/EN-15)) — [§ Phase 8](#phase-8--bookings-smart-city--tender-modules) |
...
| **6.14** | **Sprint 6.14 — UX foundation & design system v2**                   | Phase UX         | **Closed 2026-05-18** — [`master-sprint-614-exit.md`](docs/runbooks/master-sprint-614-exit.md) · tokens, tenant palette, `@enagar/ui` primitives, Storybook — [`phase-ux-revamp-plan.md`](docs/runbooks/phase-ux-revamp-plan.md)                                                                                                                             |
| **6.15** | **Sprint 6.15 — Citizen PWA hub & auth**                             | Phase UX         | **Closed 2026-05-18** — [`master-sprint-615-exit.md`](docs/runbooks/master-sprint-615-exit.md) · splash, OTP, hub, navigation (citizen-first)                                                                                                                                                                                                                |
| **6.16** | **Sprint 6.16 — Citizen PWA workspace**                              | Phase UX         | **Closed 2026-05-18** — [`master-sprint-616-exit.md`](docs/runbooks/master-sprint-616-exit.md) · tenant workspace, grievance status/priority chips, post-smoke Tricolor polish                                                                                                                                                                               |
| **6.17** | **Sprint 6.17 — Tenant Admin shell, dashboard & Desk**               | Phase UX         | **Closed** (2026-05-19) — [`master-sprint-617-exit.md`](docs/runbooks/master-sprint-617-exit.md) · operator shell, dashboard KPIs, Desk polish (B+ Pro)                                                                                                                                                                                                      |
| **6.18** | **Sprint 6.18 — Tenant Admin Masters, Operations & designer chrome** | Phase UX         | **In progress** — [`master-sprint-618-plan.md`](docs/runbooks/master-sprint-618-plan.md) · [`master-sprint-618-exit.md`](docs/runbooks/master-sprint-618-exit.md) · Masters/Operations guided UX, designer chrome, clerk admin-only routes                                                                                                                   |
| **6.19** | **Sprint 6.19 — State Admin & web cross-portal finish**              | Phase UX         | **Closed** 2026-05-19 — State portal + web smokes — [`master-sprint-619-exit.md`](docs/runbooks/master-sprint-619-exit.md)                                                                                                                                                                                                                                   |
| **6.20** | **Sprint 6.20 — Citizen mobile PWA parity**                          | Phase UX · gate  | **Closed** 2026-05-19 — [`master-sprint-620-exit.md`](docs/runbooks/master-sprint-620-exit.md)                                                                                                                                                                                                                                                               |
| **6.21** | **Sprint 6.21 — Grievance taxonomy foundation**                      | Grievance prog.  | **Closed 2026-05-19** — [`master-sprint-621-exit.md`](docs/runbooks/master-sprint-621-exit.md)                                                                                                                                                                                                                                                               |
| **6.22** | **Sprint 6.22 — Tenant Admin grievance configuration**               | Grievance prog.  | **Closed 2026-05-20** — [`master-sprint-622-exit.md`](docs/runbooks/master-sprint-622-exit.md)                                                                                                                                                                                                                                                               |
| **6.23** | **Sprint 6.23 — Citizen catalogue (PWA + mobile)**                   | Grievance prog.  | **Closed 2026-05-20** — [`master-sprint-623-exit.md`](docs/runbooks/master-sprint-623-exit.md)                                                                                                                                                                                                                                                               |
| **6.24** | **Sprint 6.24 — State library & programme exit**                     | Grievance · gate | **Closed 2026-05-20** — [`master-sprint-624-exit.md`](docs/runbooks/master-sprint-624-exit.md) · grievance taxonomy programme exit                                                                                                                                                                                                                           |
| **6.25** | **Sprint 6.25 — Object storage platform**                            | Upload prog.     | **Closed 2026-05-21** — [`master-sprint-625-exit.md`](docs/runbooks/master-sprint-625-exit.md) · `ObjectStorageModule`, presigned URLs, `confirm-upload`, MinIO bucket bootstrap — [`object-storage-upload-programme.md`](docs/runbooks/object-storage-upload-programme.md)                                                                                  |
| **6.26** | **Sprint 6.26 — Application documents (real upload + DB)**           | Upload prog.     | **Closed 2026-05-21** — [`master-sprint-626-exit.md`](docs/runbooks/master-sprint-626-exit.md) · Prisma `application_documents`, real PWA/mobile file pickers, client PUT + confirm                                                                                                                                                                          |
| **6.27** | **Sprint 6.27 — Virus scan & download**                              | Upload prog.     | **Closed 2026-05-21** — [`master-sprint-627-exit.md`](docs/runbooks/master-sprint-627-exit.md) · `@enagar/document-scan-worker`, queue on confirm-upload, download UX                                                                                                                                                                                        |
| **6.28** | **Sprint 6.28 — Grievance evidence E2E**                             | Upload prog.     | **Closed 2026-05-21** — [`master-sprint-628-exit.md`](docs/runbooks/master-sprint-628-exit.md) · grievance evidence PUT, Desk/PWA/mobile preview                                                                                                                                                                                                             |
| **6.29** | **Sprint 6.29 — Branding upload & Desk application docs**            | Upload prog.     | **Closed 2026-05-21** — [`master-sprint-629-exit.md`](docs/runbooks/master-sprint-629-exit.md) · branding upload-intent, Desk `application_documents` preview                                                                                                                                                                                                |
| **6.30** | **Sprint 6.30 — Upload programme exit**                              | Upload · gate    | **Closed 2026-05-21** — [`master-sprint-630-exit.md`](docs/runbooks/master-sprint-630-exit.md) · **Phase 7 KB `.docx` / object ingest** unblocked (Sahayak DPA/charter per open items)                                                                                                                                                                       |
| **7.1**  | **Sprint 7.1 — RAG indexer + Qdrant**                                | Master · Phase 7 | **Closed 2026-05-26** — [`master-sprint-71-exit.md`](docs/runbooks/master-sprint-71-exit.md) · Python indexer, Qdrant per tenant, embedding benchmark                                                                                                                                                                                                        |
| **7.2**  | **Sprint 7.2 — LLM adapter + PII redaction**                         | Master · Phase 7 | **Closed 2026-05-26** — [`master-sprint-72-exit.md`](docs/runbooks/master-sprint-72-exit.md) · `ILLMProvider`, OpenAI/Gemini/Ollama, redaction + audit                                                                                                                                                                                                       |
| **7.3**  | **Sprint 7.3 — Chatbot service + guardrails**                        | Master · Phase 7 | **Closed 2026-05-26** — [`master-sprint-73-exit.md`](docs/runbooks/master-sprint-73-exit.md) · SSE streaming, guardrails, failover hooks                                                                                                                                                                                                                     |
...
**Master Phase 7 — Sahayak AI — closed engineering 2026-06-03:** [`phase-7-exit.md`](docs/runbooks/phase-7-exit.md) — Jira [**EN-14**](https://ghochangfu.atlassian.net/browse/EN-14) **Done** · Sprints **7.1–7.4** (RAG indexer, LLM adapter, chatbot API, citizen Sahayak UI). VM pilot checklist: [`phase-7-vm-pilot-exit.md`](docs/runbooks/phase-7-vm-pilot-exit.md). **Deferred:** Prometheus cost dashboard; production DPA with OpenAI/Google (demo uses seed `dpa_signed`).

**Master Sprint 8.1 — Bookings calendar — closed engineering 2026-06-03:** [`master-sprint-81-exit.md`](docs/runbooks/master-sprint-81-exit.md) — Jira [**EN-15**](https://ghochangfu.atlassian.net/browse/EN-15) **Done** · hourly slots, deposit linkage, confirmation PDF, citizen `BookingWorkspace`, desk review-slot sync, KMC hall + other-facility services. **Next:** Sprint **8.2** · [**Phase 8**](#phase-8--bookings-smart-city--tender-modules) · Jira [**EN-10**](https://ghochangfu.atlassian.net/browse/EN-10).
...
**Status: closed — engineering (2026-06-03)** — [`phase-7-exit.md`](docs/runbooks/phase-7-exit.md) · Sprints **7.1–7.4** closed **2026-05-26**.
...
| 2   | DPA template signed with OpenAI + Google for chatbot                                  | ADR-0008           | Production gate (Phase 7 engineering closed; demo uses seed `dpa_signed`) |
