...
| I⅞+ | Master | **Phase 7 — Sahayak AI** (RAG + KB + LLM adapter)                                             | **Next** — after programme exit + sponsor DPA/charter items — [§ Phase 7](#phase-7--sahayak-ai-rag--kb-indexing--llm-adapter)                                                                   |
...
**Object storage & upload programme (6.25–6.30):** **Closed engineering 2026-05-21** — MinIO presign platform, Postgres `application_documents`, virus-scan worker, grievance evidence E2E, branding + Desk docs, programme exit spec + smoke ([`object-storage-upload-programme.md`](docs/runbooks/object-storage-upload-programme.md)). **Phase 7** KB file ingest may start; full Sahayak rollout still follows sponsor DPA/charter and `ROADMAP.md` gates.
...
**Next action:** Start **Phase 7 — Sahayak AI** ([§ Phase 7](#phase-7--sahayak-ai-rag--kb-indexing--llm-adapter)) after sponsor **DPA** (OpenAI/Google) and charter items in open table below. Parallel **Hub H5.1** staging / pilot readiness as capacity allows. **Sprint 3.1B** (payment gateway) stays **deferred** until sponsor unpause.
