...
**Next action:** Start **[Master Sprint 6.1](./ROADMAP.md#locked-next-10-sprint-queue-priority-execution-order)** (**queue #8**) — Tenant Admin Portal shell. Parallel **Hub H5.1** staging / pilot readiness as capacity allows. **Sprint 3.1B** (payment gateway) stays **deferred** until sponsor unpause. _(Hub **H5.1** and Master **Phase 5** sprints are distinct labels — do not confuse.)_
