...
| **6.17** | **Sprint 6.17 — Tenant Admin shell, dashboard & Desk**               | Phase UX         | **Next** — operator shell, clerk Desk polish — [`phase-ux-revamp-plan.md`](docs/runbooks/phase-ux-revamp-plan.md) §6.17                                                                                                                                                                                                                                      |
