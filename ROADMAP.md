...
| I⅞++ | Master | **Phase 8 — Bookings, Smart-City & Tenders**                                                  | **Next** — Jira [**EN-10**](https://ghochangfu.atlassian.net/browse/EN-10) — [§ Phase 8](#phase-8--bookings-smart-city--tender-modules)                                                                                                          |
...
**Next action:** Start **Phase 8 — Bookings, Smart-City & Tender Modules** ([§ Phase 8](#phase-8--bookings-smart-city--tender-modules) · Jira [**EN-10**](https://ghochangfu.atlassian.net/browse/EN-10)) with **Sprint 8.1** (bookings calendar). **Phase 7 — Sahayak AI** is **closed — engineering** ([`phase-7-exit.md`](docs/runbooks/phase-7-exit.md)). Production chatbot still needs sponsor **DPA** (open item #2). Parallel **Hub H5.1** staging / pilot readiness as capacity allows. **Sprint 3.1B** (payment gateway) stays **deferred** until sponsor unpause.
