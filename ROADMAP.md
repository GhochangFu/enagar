...
| I¾  | Master | **Sprints 6.14–6.20** — Phase UX cross-portal revamp (Tricolor Calm + tenant themes + mobile) | **Closed** 2026-05-19 — **Phase 7** (Sahayak AI) unblocked — [`phase-ux-revamp-plan.md`](docs/runbooks/phase-ux-revamp-plan.md) · [`master-sprint-620-exit.md`](docs/runbooks/master-sprint-620-exit.md) |
...
| **6.20** | **Sprint 6.20 — Citizen mobile PWA parity**                          | Phase UX · gate  | Hub + workspace + themes like `:3000` — **unblocks Phase 7** — [`master-sprint-620-plan.md`](docs/runbooks/master-sprint-620-plan.md)                                                                                                                                                                                                                        |
